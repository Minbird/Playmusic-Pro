...
include("playmusic_pro/vars.lua")
include("playmusic_pro/logger.lua")
include("playmusic_pro/setting.lua")

include("playmusic_pro/client/convars.lua")
include("playmusic_pro/client/font.lua")
include("playmusic_pro/client/cl_polys.lua")
include("playmusic_pro/client/cl_record.lua")
include("playmusic_pro/client/cl_vote.lua")
include("playmusic_pro/client/player.lua")
include("playmusic_pro/client/cl_network.lua")
include("playmusic_pro/client/cl_mainmenu.lua")
include("playmusic_pro/client/cl_option.lua")
include("playmusic_pro/client/user.lua")
include("playmusic_pro/client/old_cl_init.lua")
include("playmusic_pro/client/ui.lua")
...
local files = file.Find( "playmusic_pro/pm_lang/*.lua", "LUA" )
if #files > 0 then
	for k, files in ipairs( files ) do
		Msg( "[PlayM Pro] Language File Read: " .. files .. "\n" )
		include( "playmusic_pro/pm_lang/" .. files )
	end
else
...
local option = file.Find( "playmusic_pro/pm_options/*.lua", "LUA" )
if #option > 0 then
	for k, file in ipairs( option ) do
		Msg( "[PlayM Pro] Option File Read: " .. file .. "\n" )
		local func = CompileFile( "playmusic_pro/pm_options/" .. file )
