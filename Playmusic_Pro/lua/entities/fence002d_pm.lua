	...
	self:DrawModel()
		...
		if ( self.Mat ) then
			cam.Start3D2D(self:GetPos(), self:GetAngles(), 1)
				...
				render.DrawQuadEasy( Vector(3, 0, 0), Vector(-6.2,0,0), 256, 144, Color(255,255,255), 180)
...
cleanup.Register("fence002d_pm")
if ( CLIENT ) then
	language.Add("fence002d_pm", "PlayMusic Pro Viewer")
end
